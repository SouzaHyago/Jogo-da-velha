		...
		/* ==============
                ...
                */
                ...
                case MAIOR_CODE :
                    ...
                    str_tmp2 = ConverteRegistrador(val2);
                    str_tmp3 = ConverteRegistrador(val3);
                    sprintf(str_msg,"%s%s%s%s0",MAIOR,str_tmp1,str_tmp2,str_tmp3);
                    free(str_tmp1);
                    free(str_tmp2);
                    free(str_tmp3);
                    parser_Write_Inst(str_msg,end_cnt);
                ...
                */
                ...
                case MENOR_CODE :
                    ...
                    str_tmp2 = ConverteRegistrador(val2);
                    str_tmp3 = ConverteRegistrador(val3);
                    sprintf(str_msg,"%s%s%s%s0",MENOR,str_tmp1,str_tmp2,str_tmp3);
                    free(str_tmp1);
                    free(str_tmp2);
                    free(str_tmp3);
                    parser_Write_Inst(str_msg,end_cnt);
...
int BuscaInstrucao(char * nome)
{
    ...
    */
    ...
    else if (strcmp(str_tmp,MAIOR_STR) == 0)
    {
        return MAIOR_CODE;
    }
    else if (strcmp(str_tmp,MENOR_STR) == 0)
    {
        return MENOR_CODE;
    }
